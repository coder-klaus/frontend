...
// 使用module.exports进行导出才是作为常见的导出方式
...
知道ES6中，ECMAScript才提出了官方的模块化解决方案，ESModule，简称ESM
...
// 也就是说这里的moduleA是一个对象类型数据，可以使用点语法或中括号语法去使用其中的属性后方法
...
并且，因为所有的模块都通过入口文件来进行导出，那么我们在多处使用的时候，就只需要从对应的入口文件中导出即可

并不需要去重复编写那些重复的导入代码，提高了可扩展性和可维护性
